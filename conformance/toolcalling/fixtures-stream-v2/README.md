...
Per-chunk streaming fixtures for the TC stream conformance tab. These are the frontend-crates-owned overlay; `render_table_v2.sh` overlays them on top of the Dynamo-synced `conformance/toolcalling/fixtures/` batch corpus when building `.stage-v2/`.
