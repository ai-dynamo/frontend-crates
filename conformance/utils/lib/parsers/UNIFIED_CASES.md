...
- DeepSeek V4.1 uses the ordered Unified contract for native DSML calls, reasoning interleaving, guided JSON, and prefilled reasoning or response state. The current corpus emits 75 of the 96 taxonomy cases for this family.
