...
def test_unified_default_dynamo_uses_current_capture_and_keeps_release_history(tmp_path):
    """The current capture is selected while earlier releases remain available."""
    ...
    assert dynamo["label"] == "Dynamo v2 Rust 0.5.3 (stream, Combined & Unified)"
